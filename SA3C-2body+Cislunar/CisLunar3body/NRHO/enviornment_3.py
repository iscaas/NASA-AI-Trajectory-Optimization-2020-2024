...
class Enviornment:
    def __init__(self, eng, args):
        ...
        self.completeName_csvlist = os.path.join(save_path_1, "csvlist_2.dat") 
        self.completeName_csvlistinitialize = os.path.join(save_path_1, "csvlistinitialize_2.dat")
    ...
    def step( self, state11,state1_ND, step_nu,time,  alpha, beta ,phi_0, force, target_scaled, Px, qx, Pu, qu ,start_time ):
        ...
        self.flag_raise_error = 0
        try:
            a1 =  self.eng.Mat_env_3.resulting()
